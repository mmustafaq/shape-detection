...
void main()
{
    ...
    Mat ip_img = imread("C:/Users/Mustafa/Desktop/opencv_ornekler/ku.png");
    ...
    double gecen_zaman = double(duration_cast <nanoseconds> (end - start).count());


    cout << "gecen zaman " << gecen_zaman / 1e9;
